...
<header class="site-header">
    <div class="container header-inner">
        ...
        <button class="mobile-menu-toggle" id="mobileMenuToggle" type="button" aria-label="Toggle menu" aria-expanded="false" aria-controls="siteNavigation">
            <span></span>
            <span></span>
            <span></span>
        </button>
...
if (menuToggle && headerInner && siteNavigation && headerActions) {
